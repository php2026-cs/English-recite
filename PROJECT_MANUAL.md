...
> 最新本地验收：2026-09-11，29 个测试文件、141 项测试通过；词典加载性能优化见第 27 节。GitHub Pages 适配见第 26 节。例句目标词高亮与个人可接受答案见第 25 节，错义项再练和本机续学见第 24 节。早期部署记录仅代表当时状态，不能作为当前线上状态证明。
